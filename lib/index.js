  ...
  return function (_ref) {
    ...
    return function (next) {
      return function (action) {
        ...
        var supplemental = action && action.payload && action.payload.type ? " ["+action.payload.type+"] " : ""
        var message = "action " + formattedAction.type + supplemental + formattedTime + formattedDuration;
